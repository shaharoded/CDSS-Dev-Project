...
DELETE_MEASUREMENT_QUERY = os.path.join(PROJECT_ROOT, 'backend', 'queries', 'delete_measurement.sql')
SELECT_LAST_MEASUREMENT_FOR_DAY_QUERY = os.path.join(PROJECT_ROOT, 'backend', 'queries', 'select_last_measurement_for_day.sql')
SELECT_MEASUREMENT_TO_DELETE_QUERY = os.path.join(PROJECT_ROOT, 'backend', 'queries', 'select_measurement_to_delete.sql')